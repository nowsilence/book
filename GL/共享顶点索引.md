    ...
    <script>
        ...
        function loadShader(gl, type, source) {
            ...
            if (!gl.getShaderParameter(shader, gl.COMPILE_STATUS)) {
                alert('着色器编译失败: ' + gl.getSh 1aderInfoLog(shader));
        ...
        const programInfo = {
            ...
            attribLocations: {
                // 如果shader里定义了aPosition，却没有使用，会返回-1
                /**
                 * 未使用：
                 *  只定义，从来没读过
                 *  定义了也赋值了，但没影响最终输出
        ...
        // 每个顶点8字节，2个顶点就是16字节
        // 可以用一个很大的顶点buffer，索引大小固定，分多次渲染，每次渲染索引buffer指定的大小，这样的话可以复用索引buffer，
        gl.vertexAttribPointer(
            programInfo.attribLocations.aPosition,
            2,
            gl.FLOAT,
        ...
        gl.drawElements(
            gl.TRIANGLES, // 类型
            3, // 个数，指的是indexbuffer，指的是索引个数，一个三角形三个索引
            gl.UNSIGNED_SHORT, // 索引数据类型 gl.UNSIGNED_BYTE->Uint8Array，gl.UNSIGNED_SHORT->Uint16Array，gl.UNSIGNED_INT->Uint32Array	
            0, // offset 从索引缓冲区的第几个字节开始读
        );
    </script>
</body>
</html>
